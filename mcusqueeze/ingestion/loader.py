...
def load_model(path: str, extract_ops:bool = False, extract_shapes:bool=False):
    ...
    if ext == '.onnx':
        ...
        try:
            result = validate_onnx(str(path), extract_ops=extract_ops, extract_shapes=extract_shapes)
        ...
        result = validate_onnx(onnx_path, extract_ops=extract_ops, extract_shapes=extract_shapes)
